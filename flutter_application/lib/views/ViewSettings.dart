...
import 'package:SNQuiz/views/ViewEdit.dart';
import 'package:SNQuiz/widget/change_theme_button_widget.dart';
      ...
      if (newVersionPresent) {
        ConfirmationAlert.showConfirmationDialog(
          ...
          onConfirm: () {
            ...
            //_launchInBrowser("https://github.com/mikyll/SNQuiz/releases/latest");
